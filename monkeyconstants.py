...
MISSED_MAX_DIST = 3 * FRUIT_RADIUS # distance within which a tree is considered missed 
MAX_MEM_DIST = 500          # Maximum distance of next fruit tree in memory model (as the crow flies)
MIN_VISIT_TIMES = 10        # number of times the monkey must be in the tree to be considered a visit
